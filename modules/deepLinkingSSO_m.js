      ...
      if (kony.net.isNetworkAvailable(constants.NETWORK_TYPE_ANY)) {
        initMbaasApp(function() {
            if (kony.apps.coe.ess.appconfig.useOkta === true) {
                var oktaToken = kony.store.getItem("oktaToken");

                if(oktaToken !==null && oktaToken!=="" && kony.apps.coe.ess.frmLogin.username != "") {
                  kony.apps.coe.ess.frmLogin.oktaRefresh(oktaToken, "ssoEnable");
                } else {
                  frmLogin.show();
                }
             } else {
        ...
        if (kony.net.isNetworkAvailable(constants.NETWORK_TYPE_ANY)) {
          initMbaasApp(function() {
            if (kony.apps.coe.ess.appconfig.useOkta === true) {
                ...
                if(oktaToken !==null && oktaToken!=="" && kony.apps.coe.ess.frmLogin.username != "") {
                  kony.apps.coe.ess.frmLogin.oktaRefresh(oktaToken, "DeepLink");
                } else {
                  frmLogin.show();
                }
             } else {
