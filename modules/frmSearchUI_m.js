...
kony.apps.coe.ess.Approvals.frmSearch.ProcessData = function(response_data) {
    ...
    try {
        ...
        for (var index in response_data) {
            ...
            //date format
            processedRequest.request_date = new Date().modifyByYYYYMMDDHHMMSS(response_data[index].RequestDate).toDDmmmYY(); //toDDmmmHHMMtt()
          ...
          kony.print("______Status is "+response_data[index].StatusName+"_______");
          if (response_data[index].StatusName == "Pending") {
                processedRequest.status_value = {text:kony.i18n.getLocalizedString("i18n.ess.frmHistoryDW.Pending"),skin:"sknlblyellow"};
            } else {
